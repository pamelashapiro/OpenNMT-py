...
class CharDataset(ONMTDatasetBase):
    ...
    @staticmethod
    def make_char_examples_nfeats_tpl(path, truncate, side):
        """
        Args:
        ...
        examples_nfeats_iter = \
            CharDataset.read_text_file(path, truncate, side)
    ...
    def read_text_file(path, truncate, side):
        ...
        with codecs.open(path, "r", "utf-8") as corpus_file:
            for i, line in enumerate(corpus_file):
                ...
                words, feats, n_feats = \
                    CharDataset.extract_text_features(line)
    ...
    def get_num_features(corpus_file, side):
        ...
        with codecs.open(corpus_file, "r", "utf-8") as cf:
            ...
            _, _, num_feats = CharDataset.extract_text_features(f_line)
...
class ShardedTextCorpusIterator(object):
    ...
    def num_feats(self):
        ...
        _, _, self.n_feats = CharDataset.extract_text_features(line)
